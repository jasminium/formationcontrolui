...
function Footer() {
  return (
    <div className="bd-footer footer bg-diff2">
      ...
      <p style={{ paddingTop: "1em" }} className="mb-0">
        Designed and built by John Hartley using Python, NumPy, SciPy, Flask,{" "}
        <a href="https://gitfront.io/r/johnmatthewhartley/c81e9e54cb2749d718e54ae6517bca517097e1ae/formationplanning/">
          formationplanning
        </a>
        , React, Plotly, Bootstrap, and AWS Elastic Beanstalk.
      </p>
    </div>
  );
}
